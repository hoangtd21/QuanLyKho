    ...
    <div class="card-body">
        ...
        <div class="form-group row text-left mb-0 py-2">
            <div class="col-sm-4 py-1">
                ...
                <h6>
                    Số điện thoại: <?php echo $pn; ?>
                </h6>
            </div>
            <div class="col-sm-4 py-1"></div>
            <div class="col-sm-4 py-1">
                <h6>
                    Giao dịch #<?php echo $tid; ?>
                </h6>
                <h6 class="font-weight-bold">
                    Người lập mã: <?php echo $role; ?>
                </h6>
                <h6>
                    <?php echo $roles; ?>
                </h6>
...
?>
        ...
        <div class="form-group row text-left mb-0 py-2">
            ...
            <div class="col-sm-4 py-1">
                <h4>
                    Tiền mặt: $ <?php echo number_format($cash, 2); ?>
                </h4>
                <table width="100%">
                    <tr>
                    ...
                    <tr>
                        <td class="font-weight-bold">Thuế VAT</td>
                    ...
                    <tr>
                        <td class="font-weight-bold">Trả lại</td>
                        <td class="text-right">$ <?php echo $cash-$grand; ?></td>
                    </tr>
                </table>
            </div>
