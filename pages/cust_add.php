...
alert("Chuyển đến trang bán hàng");
...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        <div class="card-header py-3">
            <h4 class="m-2 font-weight-bold text-primary">Thêm khách hàng</h4>
        </div>
        <a href="customer.php" type="button" class="btn btn-primary bg-gradient-primary">Quay lại</a>
        <div class="card-body">
