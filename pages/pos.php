    ...
    <div class="col-lg-12">
        <div class="card shadow mb-0">
            <div class="card-header py-2">
                <h4 class="m-1 text-lg text-primary">Danh mục sản phẩm</h4>
            </div>
            <!-- /.panel-heading -->
            <div class="card-body">
                <!-- Nav tabs -->
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-target="#keyboard" data-toggle="tab">Bàn phím</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#" data-target="#mouse" data-toggle="tab">Chuột</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#headset" data-toggle="tab">Tai nghe</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#cpu" data-toggle="tab">CPU</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#monitor" data-toggle="tab">Màn hình</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#motherboard" data-toggle="tab">Bo mạch chủ</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#processor" data-toggle="tab">Bộ xử lý</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#powersupply" data-toggle="tab">Nguồn cấp điện</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#others" data-toggle="tab">Khác</a>
                    </li>
                </ul>
                ...
                <div class="card shadow mb-4 col-md-12">
                    <div class="card-header py-3 bg-white">
                        <h4 class="m-2 font-weight-bold text-primary">Điểm bán hàng</h4>
                    </div>
