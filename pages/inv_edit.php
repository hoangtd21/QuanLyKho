...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        <div class="card-header py-3">
            <h4 class="m-2 font-weight-bold text-primary">Sửa : <?php echo $A ?></h4>
        </div>
        <a type="button" class="btn btn-primary bg-gradient-primary"
            href="inv_searchfrm.php?action=edit & id='<?php echo $zzz; ?>'"><i
                class="fas fa-fw fa-flip-horizontal fa-share"></i> Quay lại</a>
        ...
        <div class="card-body">
            ...
            <form role="form" method="post" action="inv_edit1.php">
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" placeholder="Số lượng" name="qty" value="<?php echo $B; ?>"
                            required>
                    </div>
                </div>
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" placeholder="Còn trong kho" name="oh" value="<?php echo $C; ?>"
                            required>
                    </div>
                </div>
                <div class="form-group row text-left text-warning">
