                ...
                for($i=1; $i<=$countID; $i++)
                  {
                    ...
                    $query111 = "INSERT INTO `transaction`
                               ...
                               VALUES (Null,'{$customer}','{$countID}','{$subtotal}','1','1','{$addvat}','{$total}','{$cash}','{$date}','{$today}')";
                    mysqli_query($db,$query111)or die (mysqli_error($db));

                    $query2 = "DELETE FROM product WHERE PRODUCT_ID = " .$id1;
                    mysqli_query($db,$query2)or die (mysqli_error($db));


                    // $query3 = 'UPDATE product SET ON_HAND = (ON_HAND - 1) WHERE PRODUCT_ID ='  .$id1;
