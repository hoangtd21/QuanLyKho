        ...
        <div class="col-md-12 mb-3">
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-0">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">Tài khoản đã đăng kí
                            </div>
                            <div class="h6 mb-0 font-weight-bold text-gray-800">
                                <?php 
        ...
        <div class="card shadow h-100">
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    ...
                    <div class="panel-heading"> Sản phẩm gần đây
                    </div>
                        ...
                        <div class="col-auto">
                            <div class="h6 mb-0 mr-0 text-gray-800">
                              ...
                              ?>
                                    ...
                                    <!-- /.list-group -->
                                    <a href="product.php" class="btn btn-default btn-block">Xem tất cả sản phẩm</a>
                                </div>
                                <!-- /.panel-body -->
                            </div>
                        </div>
