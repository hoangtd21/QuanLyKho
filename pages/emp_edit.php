...
<center>
    <div class="card shadow mb-4 col-xs-12 col-md-8 border-bottom-primary">
        <div class="card-header py-3">
            <h4 class="m-2 font-weight-bold text-primary">Sửa Nhân viên</h4>
        ...
        <div class="card-body">
            ...
            <form role="form" method="post" action="emp_edit1.php">
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" placeholder="Vai trò" name="jobs" value="<?php echo $jobb; ?>"
                            disabled>
                    </div>
                </div>
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <input placeholder="Ngày thuê" type="date" id="FromDate" name="hireddate"
                ...
                <div class="form-group row text-left text-warning">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" placeholder="Quận/Huyện" name="city" value="<?php echo $cit; ?>"
                            required>
                    </div>
                </div>
